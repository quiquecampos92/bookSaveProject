...
export function GradientCard({ book }) {
        ...
        >
            ...
            <div className="p-4 pt-2">
                ...
                <div className="flex items-center justify-center mt-4">
                    ...
                    <AddButton handleAddButton={handleButton} text="Mark as reading" style="bg-orange-500 text-white px-4 py-2 rounded hover:text-gray-500 transition" type="text" />
                </div>
            </div>
        </div>
    );
